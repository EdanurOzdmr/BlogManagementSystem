            ...
            <div class="box-body">
                <form action="{{route('page.update', $pages->id)}}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <img width="100" src="/images/pages/{{$pages->page_file}}">
                                </div>
                        </div>
                    </div>
                    @endisset
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <input class="form-control" name="page_title" value="{{$pages->page_title}}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <input class="form-control" name="page_slug" value="{{$pages->page_slug}}">
                            </div>
                        </div>
                    </div>
