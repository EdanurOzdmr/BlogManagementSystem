...
<head>
    ...
    <title>EÖ YAZILIM | Giriş Yap</title>
...
<div class="login-box">
    <div class="login-logo">
        <a href="{{route('nedmin.login')}}"><b>EÖ</b>YAZILIM</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        ...
        <form action="{{route('nedmin.Authenticate')}}" method="post">
            ...
            <div class="form-group has-feedback">
                <input type="email" class="form-control" name="email" required placeholder="Kullanıcı Adı"
                       value="{{old('email')}}">
