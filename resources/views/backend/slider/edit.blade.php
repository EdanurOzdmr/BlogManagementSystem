            ...
            <div class="box-body">
                <form action="{{route('slider.update', $sliders->id)}}" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <img width="100" src="/images/sliders/{{$sliders->slider_file}}">
                                </div>
                        </div>
                    </div>
                    @endisset
                    ...
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <input class="form-control" name="slider_title" value="{{$sliders->slider_title}}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <input class="form-control" name="slider_slug" value="{{$sliders->slider_slug}}">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <input class="form-control" name="slider_url" value="{{$sliders->slider_url}}">
                            </div>
                        </div>
                    </div>
